      ...
      {plans.map((plan, currentIndex) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className='flex flex-row lg:flex-col gap-x-8 gap-y-8 lg:gap-y-0 lg:gap-x-0 items-center'>
                {/* name & price wrapper*/}
                <div>
                  {/* name */}
                  <div
                  ...
                  {/* price */}
                  <div className='text-[40px] lg:text-[50px] font-primary font-extrabold text-center flex flex-col items-center justify-center mb-8'>
